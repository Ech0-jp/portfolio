...
class ExpandingTextButton extends Component {
    ...
    render(){
        ...
        return (
            <a ref="dom" className={"expanding-text-button " + this.props.className} onClick={this.props.onClick} style={style} onMouseEnter={() => {this.hover(true)}} onMouseLeave={() => {this.hover(false)}}/>
        );
    }
}
