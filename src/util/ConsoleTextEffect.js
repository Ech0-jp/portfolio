var ConsoleTextEffect = (function(){
    const resolver = {
    ...
    return {
        AnimateText: function(targetElement, text, timeout = 20, addWhiteSpace = false){
        ...
        AnimateTextReverse: function(targetElement, timeout = 20, addWhiteSpace = false){
...
export default ConsoleTextEffect;
