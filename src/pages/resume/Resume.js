        ...
        return (
            <div className="resume-container">
                ...
                <PDFContainer ref="cvContainer" className="cv-pdf-container"
                    buttonContent="Cover Letter" buttonAlign="LEFT" btnWidth={144} btnHeight={50}
                    width={720} height={750} open={true} onClick={() => { this.onPdfClick('cover-letter') }}
                   ...
                   <PDFContainer ref="resumeContainer" className="resume-pdf-container"
                       buttonContent="Resume" buttonAlign="RIGHT" btnWidth={144} btnHeight={50}
                       width={720} height={750} onClick={() => { this.onPdfClick('resume') }}
                       btnContent="Resume" content={require('../../pdf/AndrewGray_Resume_Example.pdf')} />
            </div>
        );
    }
